...
interface DeleteHealthPopupProps {
    close: (action: "yes" | "no") => void;
}

export const DeleteHealthPopup: React.FC<DeleteHealthPopupProps> = ({ close }) => {
    return (
            ...
            <div className="w-1/4 bg-white p-4 rounded-lg">
                <div className="flex justify-between">
                    <div className="flex items-center">
                        ...
                        <h1 className="font-medium body-font ms-3">Delete Logs</h1>
                    </div>
                ...
                <div className="mt-5">
                    <h1 className="text-lg">Are you sure you want to delete this?</h1>
                </div>
